...
<body class="bg_blue">
      <div class="wrap_page popup">
          <div class="block_close clearfix">
              <a href="javascript:history.go(-1);" class="btn_close"><img src="img/popup/btn_close.png" /></a>
          </div>
          <div class="content">
                  <div class="inner agree">
<div class="font" style="font-weight: bold; ">개인정보 수집 · 이용에 대한 동의</div><br><br>

(주)엘지생활건강은 이벤트 진행을 위한 개인정보 수집 이용을 위하여 다음과 같이 귀하의 동의를 받고자 합니다.<br>
(주)엘지생활건강은 보다 원활한 서비스 제공을 위하여 고객의 정보를 수집하고 있습니다. 고객의 정보는 이벤트 서비스에 참여하기 위한 필수정보로써 
제공을 원하지 않을 경우 수집하지 않으며, 동의 거부 시 이벤트 참여에 제한을 받을 수 있습니다.<br><br><br>


<div class="font" style="font-weight: bold; ">(주)엘지생활건강은 본 이벤트를 위하여 다음과 같이 고객님의 개인정보를 수집 및 이용합니다.</div><br><br>
